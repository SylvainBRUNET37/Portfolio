export default [
...

  {
    ...
    conferences: [
      ...
      },
      {
        ...
        youtube: "https://www.youtube.com/watch?v=Bt3zcJZIalk",
      },
      {
  ...
  {
    section: "Design, Architecture & Best Practices",
    conferences: [
      {
        title: "Better Code: Relationships - Sean Parent (CppCon 2019)",
        youtube: "https://www.youtube.com/watch?v=ejF6qqohp3M",
      },
      {
        title: "Breaking Dependencies: The SOLID Principles - Klaus Iglberger (CppCon 2020)",
        youtube: "https://www.youtube.com/watch?v=Ntraj80qN2k",
      },
      {
        title: "C++ Code Smells - Jason Turner (CppCon 2019)",
        youtube: "https://www.youtube.com/watch?v=f_tLQl0wLUM",
      },
      {
        title: "Designing Classes (Part 1) - Klaus Iglberger (CppCon 2021)",
        youtube: "https://www.youtube.com/watch?v=motLOioLJfg",
      },
      {
        title: "C++ API Design - Jason Turner (CppCon 2022)",
        youtube: "https://www.youtube.com/watch?v=zL-vn_pGGgY",
      },
      {
        title: "How to Hide C++ Implementation Details - Amir Kirsh (CppCon 2024)",
        youtube: "https://www.youtube.com/watch?v=G5tXjYzfg9A",
      },
      {
        title: "Simplicity: Not Just For Beginners - Kate Gregory (CppCon 2018)",
        youtube: "https://www.youtube.com/watch?v=n0Ak6xtVXno",
      },
      {
        title: "Applied Best Practices - Jason Turner (CppCon 2018)",
        youtube: "https://www.youtube.com/watch?v=DHOlsEd0eDE",
      },
      {
        title: "The C++ Core Guidelines - Rainer Grimm (CppCon 2022)",
        youtube: "https://www.youtube.com/watch?v=UONLB7wBVSc",
      },
      {
        title: "C++ Design Patterns - Most Common Misconceptions (2 of N) - Klaus Iglberger (CppCon 2024)",
        youtube: "https://www.youtube.com/watch?v=pmdwAf6hCWg",
      },
    ],
  },
    ...
    conferences: [
      {
        ...
        youtube: "https://www.youtube.com/watch?v=N2gTxeIHMP0",
      },
      {
        title: "The Science of Unit Tests - Dave Steffen (CppCon 2020)",
        youtube: "https://www.youtube.com/watch?v=FjwayiHNI1w",
      },
      {
        title: "Unit Testing in C++ - Dave Steffen (CppCon 2024)",
        youtube: "https://www.youtube.com/watch?v=MwoAM3sznS0",
      },
      {
        title: "Armor-Plate Your Unit Tests - Dave Steffen (CppCon 2022)",
        youtube: "https://www.youtube.com/watch?v=P8qYIerTYA0",
      },
      {
    ...
    conferences: [
      {
        ...
        youtube: "https://www.youtube.com/watch?v=cpkDQaYttR4",
      },
      {
        title: "Debugging Techniques - Bob Steagall (CppCon 2021)",
        youtube: "https://www.youtube.com/watch?v=M7fV-eQwxrY",
      },
      {
        title: "The Basics of Profiling - Mathieu Ropert (CppCon 2021)",
        youtube: "https://www.youtube.com/watch?v=dToaepIXW4s",
      },
      {
...

  {
    ...
    conferences: [
      {
        title: "Concurrency - Arthur O'Dwyer (CppCon 2020)",
  ...
  {
    section: "Undefined Behavior, Safety & Error Handling",
    conferences: [
      {
        title: "Undefined Behavior in C++ - Fedor Pikus (CppCon 2023)",
        youtube: "https://www.youtube.com/watch?v=k9N8OrhrSZw",
      },
      {
        title: "Modern C++ Error Handling - Phil Nash (CppCon 2024)",
        youtube: "https://www.youtube.com/watch?v=n1sJtsjbkKo",
      },
      {
        title: "Exceptionally Bad - Peter Muldoon (CppCon 2023)",
        youtube: "https://www.youtube.com/watch?v=Oy-VTqz1_58",
      },
      {
        title: "Undefined Behavior - Ansel Sermersheim & Barbara Geller (CppCon 2021)",
        youtube: "https://www.youtube.com/watch?v=NpL9YnxnOqM",
      },
      {
        title: "Exceptions - Klaus Iglberger (CppCon 2020)",
        youtube: "https://www.youtube.com/watch?v=0ojB8c0xUd8",
      },
      {
        title: "What Could Possibly Go Wrong? - Brand & Nash (CppCon 2018)",
        youtube: "https://www.youtube.com/watch?v=GC4cp4U2f2E",
      },
    ],
  },

  {
    ...
    conferences: [
      ...
      {
        title: "OOP Is Dead, Long Live DOD - Stoyan Nikolov (CppCon 2018)",
        youtube: "https://www.youtube.com/watch?v=yy8jQgmhbAU",
      },
      {
        title: "C++ Game Development - Many Ways to Kill an Orc (or a Hero) - Patrice Roy - CppCon 2024",
        youtube: "https://www.youtube.com/watch?v=g-SnU4xRHMQ",
      },
      {
        title: "C++ Data Structures That Make Video Games Go Round - Al-Afiq Yeong (CppCon 2024)",
        youtube: "https://www.youtube.com/watch?v=cGB3wT0U5Ao",
      },
      {
